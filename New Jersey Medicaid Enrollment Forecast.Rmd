...
yearly_trend_forecast$`Forecast Yearly Enrollment According to Trend` <- as.numeric(gsub(",", "", yearly_trend_forecast$`Forecast Yearly Enrollment According to Trend`))
yearly_trend_forecast$Percentage_Increase <- c(NA, diff(yearly_trend_forecast$`Forecast Yearly Enrollment According to Trend`) / head(yearly_trend_forecast$`Forecast Yearly Enrollment According to Trend`, -1) * 100)

tail(yearly_trend_forecast, n = 10)
```
...
yearly_forecast$`Forecast Yearly Enrollment with Prophet` <- as.numeric(gsub(",", "", yearly_forecast$`Forecast Yearly Enrollment with Prophet`))
yearly_forecast$Percentage_Increase <- c(NA, diff(yearly_forecast$`Forecast Yearly Enrollment with Prophet`) / head(yearly_forecast$`Forecast Yearly Enrollment with Prophet`, -1) * 100)

tail(yearly_forecast, n = 10)
```
